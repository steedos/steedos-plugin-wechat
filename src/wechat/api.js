...
router.get("/api/wechat/mainpage", async function (req, res, next) {
    ...
    let signature = wechat.getSignature();
    ...
    if (o) {
        redirect_uri = encodeURIComponent(Meteor.absoluteUrl('api/wechat/auth_login'));
...
// 网页授权登录
router.get("/api/wechat/auth_login", async function (req, res, next) {
    ...
    space = wechat.getSpace();
    // 获取access_token
    if(space.qywx_corp_id && space.qywx_secret)
        token = wechat.getToken(space.qywx_corp_id,space.qywx_secret)
    ...
    if ((req != null ? (_ref5 = req.query) != null ? _ref5.code : void 0 : void 0) && token) {
        userInfo = wechat.getUserInfo(token, req.query.code);
    } else {
        res.writeHead(200, {
    ...
    if (userId && authToken) {
        if (user.user != userId) {
            wechat.clearAuthCookies(req, res);
...
router.get("/api/wechat/sso_steedos", async function (req, res, next) {
    let at, authToken, hashedToken, loginInfo, o, user, _ref5, _ref6, _ref7;
    o = ServiceConfiguration.configurations.findOne({
        service: "wechat"
    });
    at = wechat.getProviderToken(o != null ? (_ref5 = o.secret) != null ? _ref5.corpid : void 0 : void 0, o != null ? (_ref6 = o.secret) != null ? _ref6.provider_secret : void 0 : void 0);
    if (at && at.provider_access_token) {
        console.log("at.provider_access_token: ",at.provider_access_token);
        loginInfo = wechat.getLoginInfo(at.provider_access_token, req.query.auth_code);
...
// 推送消息
router.post("/api/wechat/push", async function (req, res, next) {
    ...
    let service = space.services.wechat;
    let o = ServiceConfiguration.configurations.findOne({
        service: "wechat"
    });
    at = wechat.getCorpToken(service.corp_id, service.permanent_code, o.suite_access_token);
    ...
    wechat.sendMessage(msg,service.access_token);
...
let CreateAuth = function (message) {
    ...
    if (o) {
        r = wechat.getPermanentCode(message != null ? message.SuiteId : void 0, message != null ? message.AuthCode : void 0, o != null ? (_ref5 = o) != null ? _ref5.suite_access_token : void 0 : void 0);
...
let SuiteTicket = function (message) {
    ...
    if (o) {
        r = wechat.getSuiteAccessToken(o.suite_id, o.suite_secret, message.SuiteTicket);
